...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    await sheets.spreadsheets.values.append({
      spreadsheetId,
      range: "'Hoja 1'!A:P", // USAMOS COMILLAS SIMPLES POR EL ESPACIO
