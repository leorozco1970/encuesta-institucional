...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      text: `Adjunto enviamos el diagnóstico cualitativo automatizado de 4 ejes para ${nombreInstitucion}.`,
      attachments: [{ filename: `Diagnostico_${nombreInstitucion}.pdf`, content: pdfOutput }]
    });
